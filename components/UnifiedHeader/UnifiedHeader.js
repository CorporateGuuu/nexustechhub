...
const UnifiedHeader = () => {
      ...
      submenu: [
        ...
        },
        {
          ...
          items: [
            ...
            { id: 5022, title: 'Nexus Tools', url: '/products?category=repair-tools&brand=nexus' },
  ...
  return (
    <header
      ...
      id="unified-header"
    >
      {/* Top Announcement Banner - MobileSentrix Style */}
      <div className={styles.topBanner}>
        <div className={styles.bannerContainer}>
          <span className={styles.bannerText}>
            🌟 <strong>Premium Quality Parts</strong> - Fast shipping, expert support, and unbeatable prices on all mobile device parts!
          </span>
          <Link href="/products" className={styles.bannerLink}>
            Shop Now
          </Link>
        </div>
      </div>
      ...
      {/* Main Header - MobileSentrix Layout */}
      <div className={styles.mainHeader}>
        <div className={styles.headerContainer}>
          ...
          {/* Header Actions - MobileSentrix Style */}
          <div className={styles.headerActions}>
            {/* MDTS Services Dropdown */}
            <div className={styles.servicesDropdown}>
              ...
              <div className={styles.servicesMenu}>
                <Link href="/lcd-buyback" className={styles.serviceItem}>LCD Buyback</Link>
                <Link href="/repair-services" className={styles.serviceItem}>Repair Services</Link>
                <Link href="/support" className={styles.serviceItem}>Support Center</Link>
                <Link href="/quick-order" className={styles.serviceItem}>Quick Order</Link>
                <Link href="/wholesale" className={styles.serviceItem}>Wholesale Program</Link>
              </div>
            </div>

            {/* Account Dropdown - MobileSentrix Style */}
            ...
            {/* Cart Section - MobileSentrix Style */}
            <div className={styles.cartSection}>
              <Link href="/cart" className={styles.cartLink}>
                ...
                <div className={styles.cartInfo}>
                  <span className={styles.cartLabel}>Parts</span>

      ...
      <div className={styles.container}>
        <div className={styles.top}>
          <div className={styles.newsletter}>
            ...
            <div className={styles.socialLinks}>
              <a href="https://www.instagram.com/nexustechhubuae/" target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
              ...
              <a href="https://tiktok.com/@nexustechhub" target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z" />
                </svg>
              </a>
              <a href="https://www.linkedin.com/company/nexus-tech-hub/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z" />
                </svg>
              </a>
              <a href="https://youtube.com/channel/nexustechhub" target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className={styles.middle}>
          ...
          <div className={styles.column}>
            <h3>Contact Us</h3>
            <ul className={styles.links}>
              <li>Phone: <a href="tel:+971585531029" style={{ color: 'inherit', textDecoration: 'underline' }}>+971 58 553 1029</a></li>
              <li>Address: Compass Building, Al Shohada Road, AL Hamra Industrial Zone-FZ, Ras Al Khaimah, UAE</li>
              <li>Email: <a href="mailto:support@nexustechhub.ae" style={{ color: 'inherit', textDecoration: 'underline' }}>support@nexustechhub.ae</a></li>
              <li>Hours: Sun-Thu 9AM-6PM GST</li>
              <li>
        ...
        <div className={styles.bottom}>
          <div className={styles.copyright}>
            © {new Date().getFullYear()} Nexus TechHub. All rights reserved.
          </div>

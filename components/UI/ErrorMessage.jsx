          ...
          {contactSupport && type === 'error' && (
            <div className="mt-3 pt-3 border-t border-red-200">
              ...
              <div className="mt-1 space-y-1 text-xs">
                ...
                <p>📧 Email: <a href={`mailto:${process.env.NEXT_PUBLIC_BUSINESS_EMAIL || process.env.BUSINESS_EMAIL}`} className="font-medium hover:underline">{process.env.NEXT_PUBLIC_BUSINESS_EMAIL || process.env.BUSINESS_EMAIL}</a></p>
              </div>
            </div>
          )}
        </div>

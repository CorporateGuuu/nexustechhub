...
const ChatbotUI = () => {
  ...
  const formatMessageContent = (content) => {
    ...
    // Replace URLs with clickable links (safe since input is sanitized)
    const urlRegex = /(https?:\/\/[^\s]+)/g;
    const withLinks = sanitized.replace(urlRegex, (url) => {
    ...
    <div className={styles.chatbotContainer}>
      ...
      <div className={`${styles.chatbotDialog} ${isOpen ? styles.open : ''}`}>
        ...
        <div className={styles.chatbotHeader}>
          <div className={styles.chatbotInfo}>
            <div className={styles.chatbotAvatar}>
              <img src="/images/chatbot-avatar.svg" alt="Nexus TechHub Assistant" />
            </div>
            <div className={styles.chatbotDetails}>
              <h3>Nexus TechHub Assistant</h3>
        ...
        <div className={styles.chatbotFooter}>
          <p>Powered by Nexus TechHub AI Assistant</p>
          <p className={styles.disclaimer}>This is an AI assistant. For urgent matters, please contact our support team directly at +971 58 553 1029.</p>
        </div>
      </div>
    </div>
  );

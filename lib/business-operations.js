...
const BUSINESS_CONFIG = {
  ...
  notifications: {
    ...
    email: process.env.ADMIN_EMAIL || process.env.BUSINESS_EMAIL || process.env.BUSINESS_EMAIL
  }
};
...
const UAE_KNOWLEDGE_BASE = {
  ...
  support: {
    ...
    email: process.env.SUPPORT_EMAIL || process.env.BUSINESS_EMAIL || 'support@nexustechhub.ae',
    ...
    try {
      ...
      return {
        ...
        suggestions: [
          ...
          `Email us at ${process.env.SUPPORT_EMAIL || process.env.BUSINESS_EMAIL || 'support@nexustechhub.ae'}`
        ]
      };
    }
  }

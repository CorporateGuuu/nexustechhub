      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 20px; background: #f9f9f9;">
          ...
          <div style="text-align: center; margin: 30px 0;">
            ...
            <p><strong>WhatsApp:</strong> <a href="[WHATSAPP_LINK]">Chat with us</a></p>
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 20px; background: #f9f9f9;">
          ...
          <div style="text-align: center; margin: 30px 0;">
            ...
            <p><strong>WhatsApp:</strong> <a href="[WHATSAPP_LINK]" style="background: #25d366; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Chat Now</a></p>
            <p><strong>Phone:</strong> [BUSINESS_PHONE]</p>
          </div>
        </div>
      </div>
...
class SendGridService {
  constructor() {
    this.fromEmail = process.env.SENDGRID_FROM_EMAIL || '[BUSINESS_EMAIL]' || 'noreply@nexustechhub.ae';
    this.fromName = 'Nexus TechHub UAE';
    this.adminEmail = process.env.ADMIN_EMAIL || '[BUSINESS_EMAIL]' || '[BUSINESS_EMAIL]';
  }

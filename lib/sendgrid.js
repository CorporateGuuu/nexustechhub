      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 20px; background: #f9f9f9;">
          ...
          <div style="text-align: center; margin: 30px 0;">
            ...
            <p><strong>Email:</strong> admin@nexustechhub.ae</p>
          </div>
...
class SendGridService {
  constructor() {
    this.fromEmail = process.env.SENDGRID_FROM_EMAIL || 'noreply@nexustechhub.ae';
    this.fromName = 'Nexus TechHub UAE';
    this.adminEmail = process.env.ADMIN_EMAIL || 'admin@nexustechhub.ae';
  }

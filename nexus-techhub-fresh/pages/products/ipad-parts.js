...
export default function IPadParts() {
  ...
  const ipadCategories = [
    { name: 'Screens & LCDs', slug: 'screens', count: '35+ products', icon: '📱' },
    { name: 'Batteries', slug: 'batteries', count: '20+ products', icon: '🔋' },
    { name: 'Charging Ports', slug: 'charging-ports', count: '15+ products', icon: '🔌' },
    { name: 'Home Buttons', slug: 'home-buttons', count: '12+ products', icon: '🏠' },
    { name: 'Cameras', slug: 'cameras', count: '10+ products', icon: '📷' },
    { name: 'Speakers', slug: 'speakers', count: '8+ products', icon: '🔊' },
    { name: 'Power Buttons', slug: 'power-buttons', count: '6+ products', icon: '🔘' },
    { name: 'Logic Boards', slug: 'logic-boards', count: '25+ products', icon: '⚡' }
  ];

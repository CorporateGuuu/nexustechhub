...
describe('External RepairDesk API Tests - Repair Types', () => {
  test('GET /repairtypes should return response', async () => {
    const result = await testEndpoint('/repairtypes');
  ...
  test('GET /repairtypes with invalid API key should return empty object', async () => {
    ...
    const result = await invalidTestEndpoint('/repairtypes');

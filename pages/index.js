...
function Home() {
  ...
  return (
    <Layout
      title="Nexus TechHub - Professional Repair Parts & Tools"
    ...
    >
      ...
      {/* Category Cards - Temporarily disabled */}
      {/* <Suspense fallback={<LoadingFallback />}>
        <CategoryCards />
      </Suspense> */}
      ...
      <section className="cta-section">
        <div className="container">
          ...
          <p>Nexus TechHub is proud to offer genuine Apple parts for reliable repairs. Learn more about our GAPP program.</p>

...
export default function TradeOffPage() {
  ...
  return (
    <Layout>
      <Head>
        <title>Trade-Off Program | Nexus TechHub</title>
        <meta name="description" content="Get the best prices for your broken screen trade-offs at Nexus TechHub. We offer competitive prices for iPhone, Samsung, and iPad screens." />
      </Head>

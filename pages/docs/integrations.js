          ...
          <div className={styles.docsContainer}>
            ...
            <div className={styles.docsContent}>
              ...
              <section className={styles.section}>
                ...
                <p>
                  Nexus TechHub offers seamless integration with various platforms and services to enhance your business operations.
              ...
              <section className={styles.section}>
                ...
                <div className={styles.integrationCard}>
                  ...
                  <div className={styles.integrationContent}>
                    <h3>n8n.io</h3>
                    <p>
                      Connect Nexus TechHub with n8n.io to create powerful automation workflows. n8n is a workflow automation tool
                      that allows you to connect Nexus TechHub with hundreds of other applications and services.
                    </p>
                    <h4>Key Features:</h4>
                    <ul>
                      <li>Custom workflow automation</li>
                      <li>Trigger actions based on Nexus TechHub events</li>
              ...
              <section className={styles.section}>
                ...
                <div className={styles.integrationGrid}>
                  <div className={styles.integrationGridItem}>
                    ...
                    <h3>eBay</h3>
                    <p>Sync your eBay listings with Nexus TechHub inventory</p>
                  ...
                  <div className={styles.integrationGridItem}>
                    ...
                    <h3>Amazon</h3>
                    <p>Manage Amazon listings through Nexus TechHub</p>
                    <Link href="/account?tab=integrations" className={styles.gridItemButton}>
                      Connect
                    </Link>
                  </div>
              ...
              <section className={styles.section}>
                ...
                <p>
                  For custom integrations, Nexus TechHub provides a comprehensive API that allows you to connect

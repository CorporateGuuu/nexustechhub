...
export default function Search() {
  ...
  return (
    <>
      <Head>
        <title>{searchQuery ? `Search results for "${searchQuery}"` : 'Search'} | Nexus TechHub</title>
        <meta name="description" content={`Search results for ${searchQuery || 'products'} at Nexus TechHub - Professional Repair Parts & Tools`} />
      </Head>

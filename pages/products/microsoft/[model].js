...
export default function MicrosoftModel() {
  ...
  // Mock data for different Microsoft product models
  const getModelData = (modelSlug) => {
    const modelMap = {
      // Surface Laptop Series
      'surface-laptop-5-15': {
        name: 'Surface Laptop 5 15"',
        displayName: 'Surface Laptop 5 (15")',
        category: 'Surface Laptop Series',
        releaseYear: '2022',
        display: '15" PixelSense',
        processor: 'Intel Core i5/i7',
        storage: ['256GB', '512GB', '1TB'],
        colors: ['Platinum', 'Black', 'Sage']
      },
      'surface-laptop-5-13-5': {
        name: 'Surface Laptop 5 13.5"',
        displayName: 'Surface Laptop 5 (13.5")',
        category: 'Surface Laptop Series',
        releaseYear: '2022',
      ...
      'surface-laptop-go-2': {
        ...
        displayName: 'Surface Laptop Go 2',
        category: 'Surface Laptop Series',
        releaseYear: '2022',
      ...
      'surface-laptop-4-15': {
        ...
        displayName: 'Surface Laptop 4 (15")',
        category: 'Surface Laptop Series',
        releaseYear: '2021',
        display: '15" PixelSense',
        processor: 'Intel Core i5/i7',
        storage: ['256GB', '512GB', '1TB'],
        colors: ['Platinum', 'Black', 'Matte Black']
      },

      // Surface Go Series
      'surface-go-3': {
        name: 'Surface Go 3 (2021)',
        displayName: 'Surface Go 3 (2021)',
        category: 'Surface Go Series',
        releaseYear: '2021',
        display: '10.5" PixelSense',
        processor: 'Intel Pentium Gold / Core m3',
    ...
    return modelMap[modelSlug] || {
      ...
      category: 'Microsoft Surface Product',
      releaseYear: '2023',
      colors: ['Black', 'White']
    };
  };
      ...
      parts: [
        {
          ...
          price: modelSlug.includes('laptop-5') ? 149.99 :
                 modelSlug.includes('laptop-4') ? 139.99 :
                 modelSlug.includes('laptop-go') ? 119.99 : 99.99,
        ...
        },
        {
          ...
          price: modelSlug.includes('laptop-5') ? 99.99 :
                 modelSlug.includes('laptop-4') ? 89.99 :
                 modelSlug.includes('laptop-go') ? 79.99 : 69.99,
          image: `/images/products/${modelSlug}-battery.jpg`,
          capacity: 'Original Microsoft capacity',
          compatibility: modelData.displayName,
          stock: 40,
          rating: 4.4,
          reviews: 89
      ...
      <div className={styles.modelPage}>
        ...
        <div className={styles.modelHeader}>
          ...
          <div className={styles.modelImage}>
            <img
              src={`/images/microsoft/${model}.jpg`}
        ...
        <div className={styles.relatedModels}>
          ...
          <div className={styles.modelsGrid}>
            {modelData.category === 'Surface Laptop Series' && (
              <>
                <Link href="/products/microsoft/surface-laptop-5-15" className={styles.modelLink}>
                  Surface Laptop 5 (15")
                </Link>
                <Link href="/products/microsoft/surface-laptop-5-13-5" className={styles.modelLink}>
                  Surface Laptop 5 (13.5")
                </Link>
                <Link href="/products/microsoft/surface-laptop-go-2" className={styles.modelLink}>
                  Surface Laptop Go 2
                </Link>
                <Link href="/products/microsoft/surface-laptop-4-15" className={styles.modelLink}>
                  Surface Laptop 4 (15")
                </Link>
              </>
            )}
            {modelData.category === 'Surface Go Series' && (
              <>
                <Link href="/products/microsoft/surface-go-3" className={styles.modelLink}>
                  Surface Go 3 (2021)
                </Link>
              </>
            )}
...
export async function getStaticPaths() {
  // Generate paths for popular Microsoft Surface product models
  const models = [
    // Surface Laptop Series
    'surface-laptop-5-15',
    'surface-laptop-5-13-5',

...
export default function AsusModel() {
  ...
  // Mock data for different Asus product models
  const getModelData = (modelSlug) => {
    const modelMap = {
      // ROG Phone Series
      'rog-phone-9-pro': {
        name: 'ROG Phone 9 Pro',
        displayName: 'ROG Phone 9 Pro',
        category: 'ROG Phone Series',
        releaseYear: '2024',
        display: '6.78" AMOLED',
    ...
    return modelMap[modelSlug] || {
      ...
      category: 'Asus ROG Phone Product',
      releaseYear: '2024',
      colors: ['Black', 'White']
    };
  };
      ...
      parts: [
        {
          ...
          price: modelSlug.includes('rog-phone-9') ? 149.99 :
                 modelSlug.includes('rog-phone-8') ? 139.99 :
                 modelSlug.includes('rog-phone-7') ? 129.99 : 119.99,
        ...
        },
        {
          ...
          price: modelSlug.includes('rog-phone-9') ? 99.99 :
                 modelSlug.includes('rog-phone-8') ? 89.99 :
                 modelSlug.includes('rog-phone-7') ? 79.99 : 69.99,
          image: `/images/products/${modelSlug}-battery.jpg`,
          capacity: 'Original Asus capacity',
          compatibility: modelData.displayName,
          stock: 40,
          rating: 4.4,
          reviews: 89
      ...
      <div className={styles.modelPage}>
        ...
        <div className={styles.relatedModels}>
          ...
          <div className={styles.modelsGrid}>
            {modelData.category === 'ROG Phone Series' && (
              <>
                <Link href="/products/asus/rog-phone-9-pro" className={styles.modelLink}>
                  ROG Phone 9 Pro
                </Link>
                <Link href="/products/asus/rog-phone-9" className={styles.modelLink}>
                  ROG Phone 9
                </Link>
                <Link href="/products/asus/rog-phone-8-pro" className={styles.modelLink}>
                  ROG Phone 8 Pro
                </Link>
                <Link href="/products/asus/rog-phone-8" className={styles.modelLink}>
                  ROG Phone 8
                </Link>
                <Link href="/products/asus/rog-phone-7-pro" className={styles.modelLink}>
                  ROG Phone 7 Pro
                </Link>
                <Link href="/products/asus/rog-phone-7" className={styles.modelLink}>
                  ROG Phone 7
                </Link>
                <Link href="/products/asus/rog-phone-6-pro" className={styles.modelLink}>
                  ROG Phone 6 Pro
                </Link>
                <Link href="/products/asus/rog-phone-6" className={styles.modelLink}>
                  ROG Phone 6
                </Link>
              </>
            )}
...
export async function getStaticPaths() {
  // Generate paths for popular Asus ROG Phone product models
  const models = [
    // ROG Phone Series
    'rog-phone-9-pro',
    'rog-phone-9',

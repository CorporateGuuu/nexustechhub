...
export default function SearchAnalytics() {
  ...
  return (
    <>
      <Head>
        <title>Search Analytics | Nexus TechHub Admin</title>
        <meta name="description" content="Search analytics dashboard for Nexus TechHub admin" />
      </Head>

      <div className={styles.adminContainer}>
        <div className={styles.adminSidebar}>
          <h2 className={styles.adminLogo}>Nexus TechHub Admin</h2>

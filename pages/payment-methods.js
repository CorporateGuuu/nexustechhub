...
function PaymentMethods() {
  return (
    <Layout
      title="Payment Methods - Nexus TechHub"
      description="Learn about the payment options available at Nexus TechHub, including credit cards, PayPal, cryptocurrency, and financing options."
    >
      <div className="container" style={{ padding: '40px 20px', maxWidth: '800px', margin: '0 auto' }}>
        <h1 style={{ fontSize: '2rem', marginBottom: '1.5rem' }}>Payment Methods</h1>

        <p style={{ marginBottom: '2rem', lineHeight: '1.6' }}>
          At Nexus TechHub, we offer a variety of secure payment options to make your shopping experience as convenient as possible.
        </p>

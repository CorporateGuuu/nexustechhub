...
function QualityStandards() {
  return (
    <Layout
      title="Quality Standards - Nexus TechHub"
      description="Learn about Nexus TechHub's commitment to quality, our rigorous testing processes, and the standards we maintain for all our products."
    >

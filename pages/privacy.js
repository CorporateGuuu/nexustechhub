        ...
        <div className="container" style={{ padding: '40px 20px', maxWidth: '800px', margin: '0 auto' }}>
          ...
          <section style={{ marginBottom: '2rem' }}>
            ...
            <ul style={{ marginLeft: '1.5rem', lineHeight: '1.6', marginBottom: '1.5rem' }}>
              <li style={{ marginBottom: '0.5rem' }}>Register on the Site</li>
              <li style={{ marginBottom: '0.5rem' }}>Place an order</li>
              <li style={{ marginBottom: '0.5rem' }}>Subscribe to our newsletter</li>
              <li style={{ marginBottom: '0.5rem' }}>Participate in contests, surveys, or promotions</li>
              <li style={{ marginBottom: '0.5rem' }}>Contact our customer service</li>
            </ul>
            <p style={{ marginBottom: '1rem', lineHeight: '1.6' }}>
            ...
            <ul style={{ marginLeft: '1.5rem', lineHeight: '1.6', marginBottom: '1.5rem' }}>
              ...
              <li style={{ marginBottom: '0.5rem' }}>Mailing address</li>
            ...
            <ul style={{ marginLeft: '1.5rem', lineHeight: '1.6' }}>
              <li style={{ marginBottom: '0.5rem' }}>Device information (browser type, operating system, device type)</li>
              <li style={{ marginBottom: '0.5rem' }}>IP address</li>
              <li style={{ marginBottom: '0.5rem' }}>Browsing actions and patterns</li>
          ...
          <section style={{ marginBottom: '2rem' }}>
            ...
            <ul style={{ marginLeft: '1.5rem', lineHeight: '1.6' }}>
              <li style={{ marginBottom: '0.5rem' }}>Processing and fulfilling orders</li>
              <li style={{ marginBottom: '0.5rem' }}>Creating and managing your account</li>
              <li style={{ marginBottom: '0.5rem' }}>Providing customer service</li>
              <li style={{ marginBottom: '0.5rem' }}>Sending transactional emails (order confirmations, shipping updates)</li>
              <li style={{ marginBottom: '0.5rem' }}>Sending marketing communications (if you've opted in)</li>
              <li style={{ marginBottom: '0.5rem' }}>Improving our website and products</li>
              <li style={{ marginBottom: '0.5rem' }}>Analyzing usage patterns and trends</li>
              <li style={{ marginBottom: '0.5rem' }}>Detecting and preventing fraud</li>
          ...
          <section style={{ marginBottom: '2rem' }}>
            ...
            <ul style={{ marginLeft: '1.5rem', lineHeight: '1.6' }}>
              <li style={{ marginBottom: '0.5rem' }}>Keeping you signed in</li>
              <li style={{ marginBottom: '0.5rem' }}>Understanding how you use our site</li>
              <li style={{ marginBottom: '0.5rem' }}>Remembering items in your shopping cart</li>
          ...
          <section style={{ marginBottom: '2rem' }}>
            ...
            <ul style={{ marginLeft: '1.5rem', lineHeight: '1.6' }}>
              <li style={{ marginBottom: '0.5rem' }}>Right to access your personal information</li>
              <li style={{ marginBottom: '0.5rem' }}>Right to correct inaccurate information</li>
              <li style={{ marginBottom: '0.5rem' }}>Right to request deletion of your information</li>
              <li style={{ marginBottom: '0.5rem' }}>Right to restrict processing of your information</li>

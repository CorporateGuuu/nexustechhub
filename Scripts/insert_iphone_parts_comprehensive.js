...
/**
 * Insert Comprehensive iPhone Parts and LCDs Data into Supabase
 * This script inserts detailed iPhone parts and LCDs for iPhone 15, 14, 13, and 12 series
 */
...
async function insertProducts() {
  console.log('📱 Inserting comprehensive iPhone parts and LCDs...');
...
async function main() {
  console.log('🚀 Starting comprehensive iPhone parts and LCDs data insertion...');

  try {
    await insertProducts();
    await insertProductSpecifications();

    console.log('✅ Comprehensive iPhone parts and LCDs data insertion completed successfully!');
    console.log('📱 Your Supabase database now contains detailed iPhone parts for 15, 14, 13, and 12 series.');

    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading USB-C cables...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        <Breadcrumb items={[
          ...
          { label: 'Chargers & Cables', href: '/parts/accessories/chargers-cables' },
          { label: 'USB-C Cables' }
        ]} />
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-6 text-purple-100">
              60W / 100W PD • Braided Nylon • 3ft – 10ft • MFi Certified
            </p>
            ...
            <div className="mt-8">
              <Link
                ...
                className="inline-flex items-center gap-2 bg-white text-purple-600 px-6 py-3 rounded-lg hover:bg-purple-50 transition-colors font-medium"
              >
                View all chargers & cables <ArrowRight className="w-4 h-4" />
              </Link>
            </div>
          </div>
        </div>
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center justify-between mb-6">
              <p className="text-gray-600">
                {filteredAndSortedProducts.length} USB-C cable{filteredAndSortedProducts.length !== 1 ? 's' : ''} found
                {activeFiltersCount > 0 && (
                  <span className="ml-2">

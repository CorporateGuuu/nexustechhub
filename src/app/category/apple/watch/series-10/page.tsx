...
export const metadata = {
  title: 'Apple Watch Series 10 Parts - Screens, Batteries, Repairs | Nexus Tech Hub',
  description: 'Premium replacement parts for Apple Watch Series 10. Screens, batteries, bands, sensors. Fast USA shipping.',
};
          ...
          <div className="max-w-7xl mx-auto px-4 py-12">
            <div className="text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">
                Apple Watch Series 10 Parts
              </h1>
              <p className="text-xl md:text-2xl mb-6 text-red-100">
                Thinnest Design • Advanced Health • Always-On Display
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Premium quality replacement parts for your Apple Watch Series 10. All parts are tested and guaranteed to work.
            </p>
          </div>
          ...
          {products.length === 0 && (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {[
                { name: 'Always-On Retina Display', price: 'Coming Soon', category: 'Displays' },

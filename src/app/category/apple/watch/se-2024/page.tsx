...
export const metadata = {
  title: 'Apple Watch SE (2024) Parts - Screens, Batteries, Repairs | Nexus Tech Hub',
  description: 'Premium replacement parts for Apple Watch SE (2024). Screens, batteries, bands, sensors. Fast USA shipping.',
};
          ...
          <div className="max-w-7xl mx-auto px-4 py-12">
            <div className="text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">
                Apple Watch SE (2024) Parts
              </h1>
              <p className="text-xl md:text-2xl mb-6 text-red-100">
                Essential Features • Great Value • Health & Safety
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Premium quality replacement parts for your Apple Watch SE (2024). All parts are tested and guaranteed to work.
            </p>
          </div>

...
export const metadata = {
  title: 'iPad Pro 12.9" 6th Gen Parts - Screens, Batteries, Repairs | Nexus Tech Hub',
  description: 'Premium replacement parts for iPad Pro 12.9" 6th Gen (M2 Chip). Screens, batteries, cameras, charging ports. Fast USA shipping.',
};
          ...
          <div className="max-w-7xl mx-auto px-4 py-12">
            <div className="text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">
                iPad Pro 12.9" 6th Gen Parts
              </h1>
              <p className="text-xl md:text-2xl mb-6 text-blue-100">
                M2 Chip • Liquid Retina XDR • Ultra-Thin Design
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Premium quality replacement parts for your iPad Pro 12.9" 6th Gen. All parts are tested and guaranteed to work.
            </p>
          </div>
          ...
          {products.length === 0 && (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {[
                { name: 'Liquid Retina XDR Display', price: 'Coming Soon', category: 'Displays' },

...
export const metadata = {
  title: 'AirPods Pro 2 Parts - Batteries, Cases, Repairs | Nexus Tech Hub',
  description: 'Premium replacement parts for AirPods Pro 2. Batteries, charging cases, drivers, sensors. Fast USA shipping.',
};
          ...
          <div className="max-w-7xl mx-auto px-4 py-12">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-6 text-purple-100">
                Active Noise Cancellation • Spatial Audio • Premium Sound
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <Link
                  ...
                  className="inline-flex items-center px-6 py-3 bg-white text-purple-600 rounded-lg hover:bg-purple-50 transition-all duration-200 font-medium"
                >
                  View AirPods Parts →
                </Link>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Premium quality replacement parts for AirPods Pro 2. All parts are tested and guaranteed to work.
            </p>
          </div>
          ...
          {products.length === 0 && (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {[
                { name: 'Left Earbud', price: 'Coming Soon', category: 'Earbuds' },
                { name: 'Right Earbud', price: 'Coming Soon', category: 'Earbuds' },
                { name: 'Charging Case', price: 'Coming Soon', category: 'Cases' },
                { name: 'Earbud Batteries', price: 'Coming Soon', category: 'Batteries' },
                { name: 'Case Battery', price: 'Coming Soon', category: 'Batteries' },
                { name: 'Drivers', price: 'Coming Soon', category: 'Audio' },
                { name: 'Microphones', price: 'Coming Soon', category: 'Audio' },
                { name: 'Sensors', price: 'Coming Soon', category: 'Sensors' },
              ].map((part, index) => (

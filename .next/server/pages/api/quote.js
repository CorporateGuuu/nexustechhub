...
<body>
    ...
    `.trim(),x=d(),S={from:process.env.EMAIL_FROM||"noreply@nexustechhub.com",to:process.env.EMAIL_TO||"quotes@nexustechhub.com",subject:$,text:A,html:q,replyTo:b.email},E=await x.sendMail(S);console.log("✅ Quote request submission successful:",{quoteId:y,messageId:E.messageId,name:b.name,email:b.email,totalItems:f.totalItems,subtotal:f.subtotal,timestamp:b.timestamp}),s.status(200).json({success:!0,message:"Quote request submitted successfully! We will send you a detailed quote within 24 hours.",data:{quoteId:y,messageId:E.messageId,timestamp:b.timestamp,products:v,totals:f}})}catch(e){console.error("❌ Quote request submission error:",e),s.status(500).json({success:!1,message:"Sorry, there was an error processing your quote request. Please try again or contact us directly at +971 58 553 1029.",error:void 0})}}let h={api:{bodyParser:{sizeLimit:"2mb"}}},b=(0,r.l)(a,"default"),v=(0,r.l)(a,"config"),f=new i.PagesAPIRouteModule({definition:{kind:n.x.PAGES_API,page:"/api/quote",pathname:"/api/quote",bundlePath:"",filename:""},userland:a})},47153:(e,s)=>{var t;Object.defineProperty(s,"x",{enumerable:!0,get:function(){return t}}),function(e){e.PAGES="PAGES",e.PAGES_API="PAGES_API",e.APP_PAGE="APP_PAGE",e.APP_ROUTE="APP_ROUTE"}(t||(t={}))},71802:(e,s,t)=>{e.exports=t(20145)}};var s=require("../../webpack-api-runtime.js");s.C(e);var t=s(s.s=59770);module.exports=t})();